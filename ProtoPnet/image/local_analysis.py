...
test_image_dir = './ravdess_ori/Ravdata_Ori_split/test/angry'
test_image_name = '01-02-05-01-01-01-02_frame0_grid.jpg'
test_image_label = 0
...
load_model_dir = './saved_models/vgg16_bn/Rav_cutsori_vgg16_bn 60 16'
load_model_name = '90push_snapshot0.9938.pth'
...
model_base_architecture = 'vgg16_bn'
experiment_run = 'Rav_part'
...
labels_test = torch.tensor([int(test_image_label)])
